...
.Synopsis
   Short description
.DESCRIPTION
   Copied from: https://www.administrator.de/wissen/powershell-funktion-credentials-anmeldeinformationsverwaltung-tresor-hinzuf%C3%BCgen-nativ-cmdkey-exe-239337.html
   Long description
.EXAMPLE
